...
//Collection of Station
const std::vector<Station> Railways::sStations {Station::createStation("Mumbai"), Station::createStation("Delhi"), Station::createStation("Bangalore"), Station::createStation("Kolkata"),Station::createStation("Chennai")};
...
{
	for(auto i{Railways::sDistances.begin()};i!=Railways::sDistances.end();i++)
	{
...
void Railways::UnitTestRailways()// Test application for Railways
{
	...
	std::cout << "Distance between Mumbai and Kolkata as obtained from Railways::IndianRailways().GetDistance(Station(\"Mumbai\"), Station(\"Kolkata\")) is " << Railways::IndianRailways().GetDistance(Station::createStation("Mumbai"), Station::createStation("Kolkata")) << std::endl;
	if(Railways::IndianRailways().GetDistance(Station::createStation("Mumbai"), Station::createStation("Kolkata")) != 2014)
	{
